...
Но потом превратился в поле для развелечений и эксперементов @mezhendosina, в котором есть(или когда-то побывали):
- Список направлений вузов, в которые поступает @mezhendosina
- Результаты ЕГЭ @mezhendosina
- Генератор гороскопа с помощью нейронок OpenAi
- Рейтинг прогульщиков
- Рандомайзер кубиков в Telegram
А домашку скидывает самый лучшее приложение электронного дневника @sgo-app